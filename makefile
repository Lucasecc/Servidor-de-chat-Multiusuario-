...
$(CLIENT_EXE): $(CLIENT_SRC) $(LIB_OBJ)
	$(CXX) $(CXXFLAGS) $(CLIENT_SRC) $(LIB_OBJ) -o $(CLIENT_EXE) $(LDFLAGS)

$(TEST_CLIENTS_EXE): $(TEST_CLIENTS_SRC) $(LIB_OBJ)
	$(CXX) $(CXXFLAGS) $(TEST_CLIENTS_SRC) $(LIB_OBJ) -o $(TEST_CLIENTS_EXE) $(LDFLAGS)

clean:
	rm -f $(SERVER_EXE) $(CLIENT_EXE) $(TEST_CLIENTS_EXE) src/*.o
	rm -rf logs/
